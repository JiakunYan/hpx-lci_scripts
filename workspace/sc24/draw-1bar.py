...
job_name_dict = {
    "Expanse": {
        "mbench": "../../hpx_pingpong/sc24/data/expanse.csv",
        "bench": "../../octotiger/sc24/data/expanse.csv"
    },
    "Frontera": {
        "mbench": "../../hpx_pingpong/sc24/data/frontera.csv",
        "bench": "../../octotiger/sc24/data/frontera.csv"
    },
    "Delta": {
        "mbench": "../../hpx_pingpong/sc24/data/delta.csv",
        "bench": "../../octotiger/sc24/data/delta.csv"
    }
}
platform = "Expanse"
# platform = "Frontera"
